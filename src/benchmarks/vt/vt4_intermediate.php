...
{
    $result = db()->select('vt_s4', $scenario, $scenario . '_rank')->fetchAll();
...
<body class='bg-dark'>
    ...
    <div class='container'>
        <span class='text-success'><a href='https://docs.google.com/spreadsheets/d/1qUzF2KHcfs_FgsaDFRfGsLgHhoC1Md5bzMOUbsYzSjg/' target='_blank'><button class='btn btn-dark'><i class=" bi bi-box-arrow-up-left"></i></button></a> Voltaic KvKs Benchmarks S4 - Intermediate</span>
