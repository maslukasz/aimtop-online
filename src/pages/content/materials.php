            ...
            <li class=" inline text-gray-100 animate-bounce">|</li>
                ...
                <div id="vt-content" class="hidden">
                    <ul class="border border-purple-300 border-solid p-3">
                        ...
                        <li><a href='https://bit.ly/VTxALfundamentals' target='_blank'
                                class="hover:underline">Fundamentals</a></li>
                ...
                <div id="ra-content" class="hidden">
                    <ul class="border border-red-300 border-solid p-3">
                        <li><a href='https://discord.gg/revosect' target='_blank'
                                class='hover:border text-[#7289da]'>Server discord</a> (all resources are available
                            there)</li>
                        ...
                        <li><a href='https://bit.ly/rAValorant' target='_blank' class='hover:underline'>Valorant
                                routine</a></li>
                        <li><a href='https://go.aimlab.gg/v1/redirects?link=aimlab://workshop?id=3083294768'
                                target='_blank' class='hover:underline'>CS2
                                routine</a></li>
                    </ul>
                </div>
